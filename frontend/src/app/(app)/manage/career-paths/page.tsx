...
export default function ManageCareerPathsPage() {
  ...
  if (!canEdit) return <ComingSoon title="Career Paths" />;
    ...
    <div className="mx-auto max-w-3xl p-8">
      ...
      {isLoading ? (
        ...
        <Card className="flex flex-col items-center gap-2 p-10 text-center">
          <p className="text-sm font-semibold text-text-primary">No career paths yet</p>
          <p className="text-xs text-text-tertiary">
            Name a target role, then add the skills someone needs to get there.
          </p>
        </Card>
      ) : (
        <Table>
